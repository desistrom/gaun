...
define('URL_GET_ALL_VIDEO','http://localhost/idren/api/v1/galery_video');
define('URL_GET_ID_TUBE','http://localhost/idren/api/v1/tube_video');
define('URL_GET_VIDEO_PAGGING','http://localhost/idren/api/v1/galery_video_pagging?data=');
define('URL_GET_ID_TUBE_PAGGING','http://localhost/idren/api/v1/tube_video_pagging?data=');
define('URL_GET_GALERY_BY_ID','http://localhost/idren/api/v1/select_galery');
define('URL_GET_IMAGE_BY_ID','http://localhost/idren/api/v1/search_galery_image');
define('URL_GET_VIDEO_BY_ID','http://localhost/idren/api/v1/search_galery_video');
define('URL_REGISTER','http://localhost/idren/api/v1/insert_instansi');
define('URL_INSERT_CONTACT_US','http://localhost/idren/api/v1/insert_contact');
define('URL_GET_ABOUT','http://localhost/idren/api/v1/about');
define('URL_GET_PENDAFTARAN','http://localhost/idren/api/v1/step');
define('URL_GET_BENEFIT','http://localhost/idren/api/v1/profit');
define('URL_GET_ALL_INSTANSI','http://localhost/idren/api/v1/instansi');
define('URL_SEARCH_INSTANSI','http://localhost/idren/api/v1/search_instansi');
define('URL_GET_INSTANSI_PAGGING','http://localhost/idren/api/v1/instansi_pagging?data=');
define('URL_GET_ALL_NEWS','http://localhost/idren/api/v1/news');
define('URL_GET_NEWS_PAGGING','http://localhost/idren/api/v1/pagging_news?data=');
define('URL_SEARCH_NEWS','http://localhost/idren/api/v1/search_news');
define('URL_GET_NEWS_BY_ID','http://localhost/idren/api/v1/get_news_byid');
define('URL_GET_NEWS_BY_SLUG','http://localhost/idren/api/v1/get_news_byslug?news=');
define('URL_GET_RSS','http://localhost/idren/api/v1/get_rss');
...
define('URL_GET_ALL_VIDEO','http://128.199.233.73/idren/api/v1/galery_video');
define('URL_GET_ID_TUBE','http://128.199.233.73/idren/api/v1/tube_video');
define('URL_GET_VIDEO_PAGGING','http://128.199.233.73/idren/api/v1/galery_video_pagging?data=');
define('URL_GET_ID_TUBE_PAGGING','http://128.199.233.73/idren/api/v1/tube_video_pagging?data=');
define('URL_GET_GALERY_BY_ID','http://128.199.233.73/idren/api/v1/select_galery');
define('URL_GET_IMAGE_BY_ID','http://128.199.233.73/idren/api/v1/search_galery_image');
define('URL_GET_VIDEO_BY_ID','http://128.199.233.73/idren/api/v1/search_galery_video');
define('URL_REGISTER','http://128.199.233.73/idren/api/v1/insert_instansi');
define('URL_INSERT_CONTACT_US','http://128.199.233.73/idren/api/v1/insert_contact');
define('URL_GET_ABOUT','http://128.199.233.73/idren/api/v1/about');
define('URL_GET_PENDAFTARAN','http://128.199.233.73/idren/api/v1/step');
define('URL_GET_BENEFIT','http://128.199.233.73/idren/api/v1/profit');
define('URL_GET_ALL_INSTANSI','http://128.199.233.73/idren/api/v1/instansi');
define('URL_SEARCH_INSTANSI','http://128.199.233.73/idren/api/v1/search_instansi');
define('URL_GET_INSTANSI_PAGGING','http://128.199.233.73/idren/api/v1/instansi_pagging?data=');
define('URL_GET_ALL_NEWS','http://128.199.233.73/idren/api/v1/news');
define('URL_GET_NEWS_PAGGING','http://128.199.233.73/idren/api/v1/pagging_news?data=');
define('URL_SEARCH_NEWS','http://128.199.233.73/idren/api/v1/search_news');
define('URL_GET_NEWS_BY_ID','http://128.199.233.73/idren/api/v1/get_news_byid');
define('URL_GET_NEWS_BY_SLUG','http://128.199.233.73/idren/api/v1/get_news_byslug?news=');
define('URL_GET_RSS','http://128.199.233.73/idren/api/v1/get_rss');
...
define('URL_GET_ALL_VIDEO','http://103.107.100.9/idren_new/api/v1/galery_video');
define('URL_GET_ID_TUBE','http://103.107.100.9/idren_new/api/v1/tube_video');
define('URL_GET_VIDEO_PAGGING','http://103.107.100.9/idren_new/api/v1/galery_video_pagging?data=');
define('URL_GET_ID_TUBE_PAGGING','http://103.107.100.9/idren_new/api/v1/tube_video_pagging?data=');
define('URL_GET_GALERY_BY_ID','http://103.107.100.9/idren_new/api/v1/select_galery');
define('URL_GET_IMAGE_BY_ID','http://103.107.100.9/idren_new/api/v1/search_galery_image');
define('URL_GET_VIDEO_BY_ID','http://103.107.100.9/idren_new/api/v1/search_galery_video');
define('URL_REGISTER','http://103.107.100.9/idren_new/api/v1/insert_instansi');
define('URL_INSERT_CONTACT_US','http://103.107.100.9/idren_new/api/v1/insert_contact');
define('URL_GET_ABOUT','http://103.107.100.9/idren_new/api/v1/about');
define('URL_GET_PENDAFTARAN','http://103.107.100.9/idren_new/api/v1/step');
define('URL_GET_BENEFIT','http://103.107.100.9/idren_new/api/v1/profit');
define('URL_GET_ALL_INSTANSI','http://103.107.100.9/idren_new/api/v1/instansi');
define('URL_SEARCH_INSTANSI','http://103.107.100.9/idren_new/api/v1/search_instansi');
define('URL_GET_INSTANSI_PAGGING','http://103.107.100.9/idren_new/api/v1/instansi_pagging?data=');
define('URL_GET_ALL_NEWS','http://103.107.100.9/idren_new/api/v1/news');
define('URL_GET_NEWS_PAGGING','http://103.107.100.9/idren_new/api/v1/pagging_news?data=');
define('URL_SEARCH_NEWS','http://103.107.100.9/idren_new/api/v1/search_news');
define('URL_GET_NEWS_BY_ID','http://103.107.100.9/idren_new/api/v1/get_news_byid');
define('URL_GET_NEWS_BY_SLUG','http://103.107.100.9/idren_new/api/v1/get_news_byslug?news=');
define('URL_GET_RSS','http://103.107.100.9/idren_new/api/v1/get_rss');
...
define('URL_GET_ALL_VIDEO','http://localhost/idren/api/v2/galery_video');
define('URL_GET_ID_TUBE','http://localhost/idren/api/v2/tube_video');
define('URL_GET_VIDEO_PAGGING','http://localhost/idren/api/v2/galery_video_pagging?data=');
define('URL_GET_ID_TUBE_PAGGING','http://localhost/idren/api/v2/tube_video_pagging?data=');
define('URL_GET_GALERY_BY_ID','http://localhost/idren/api/v2/select_galery');
define('URL_GET_IMAGE_BY_ID','http://localhost/idren/api/v2/search_galery_image');
define('URL_GET_VIDEO_BY_ID','http://localhost/idren/api/v2/search_galery_video');
define('URL_REGISTER','http://localhost/idren/api/v2/insert_instansi');
define('URL_INSERT_CONTACT_US','http://localhost/idren/api/v2/insert_contact');
define('URL_GET_ABOUT','http://localhost/idren/api/v2/about');
define('URL_GET_PENDAFTARAN','http://localhost/idren/api/v2/step');
define('URL_GET_BENEFIT','http://localhost/idren/api/v2/profit');
define('URL_GET_ALL_INSTANSI','http://localhost/idren/api/v2/instansi');
define('URL_SEARCH_INSTANSI','http://localhost/idren/api/v2/search_instansi');
define('URL_GET_INSTANSI_PAGGING','http://localhost/idren/api/v2/instansi_pagging?data=');
define('URL_GET_ALL_NEWS','http://localhost/idren/api/v2/news');
define('URL_GET_NEWS_PAGGING','http://localhost/idren/api/v2/pagging_news?data=');
define('URL_SEARCH_NEWS','http://localhost/idren/api/v2/search_news');
define('URL_GET_NEWS_BY_ID','http://localhost/idren/api/v2/get_news_byid');
define('URL_GET_NEWS_BY_SLUG','http://localhost/idren/api/v2/get_news_byslug?news=');
define('URL_GET_RSS','http://localhost/idren/api/v2/get_rss');
define('URL_GET_TESTIMONI','http://localhost/idren/api/v2/gettestimoni');
define('URL_GET_TESTIMONI_PAGGING','http://localhost/idren/api/v2/gettestimoni_pagging?data=');
define('URL_GET_HERO','http://localhost/idren/api/v2/gethero');
define('URL_GET_TOPOLOGI','http://localhost/idren/api/v2/gettopologi');
