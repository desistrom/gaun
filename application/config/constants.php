...
define('URL_GET_ALL_VIDEO_V2','http://128.199.233.73/idren/api/v2/galery_video');
define('URL_GET_ID_TUBE_V2','http://128.199.233.73/idren/api/v2/tube_video');
define('URL_GET_VIDEO_PAGGING_V2','http://128.199.233.73/idren/api/v2/galery_video_pagging?data=');
define('URL_GET_ID_TUBE_PAGGING_V2','http://128.199.233.73/idren/api/v2/tube_video_pagging?data=');
define('URL_GET_GALERY_BY_ID_V2','http://128.199.233.73/idren/api/v2/select_galery');
define('URL_GET_IMAGE_BY_ID_V2','http://128.199.233.73/idren/api/v2/search_galery_image');
define('URL_GET_VIDEO_BY_ID_V2','http://128.199.233.73/idren/api/v2/search_galery_video');
define('URL_REGISTER_V2','http://128.199.233.73/idren/api/v2/insert_instansi');
define('URL_INSERT_CONTACT_US_V2','http://128.199.233.73/idren/api/v2/insert_contact');
define('URL_GET_ABOUT_V2','http://128.199.233.73/idren/api/v2/about');
define('URL_GET_PENDAFTARAN_V2','http://128.199.233.73/idren/api/v2/step');
define('URL_GET_BENEFIT_V2','http://128.199.233.73/idren/api/v2/profit');
define('URL_GET_ALL_INSTANSI_V2','http://128.199.233.73/idren/api/v2/instansi');
define('URL_SEARCH_INSTANSI_V2','http://128.199.233.73/idren/api/v2/search_instansi');
define('URL_GET_INSTANSI_PAGGING_V2','http://128.199.233.73/idren/api/v2/instansi_pagging?data=');
define('URL_GET_ALL_NEWS_V2','http://128.199.233.73/idren/api/v2/news');
define('URL_GET_NEWS_PAGGING_V2','http://128.199.233.73/idren/api/v2/pagging_news?data=');
define('URL_SEARCH_NEWS_V2','http://128.199.233.73/idren/api/v2/search_news');
define('URL_GET_NEWS_BY_ID_V2','http://128.199.233.73/idren/api/v2/get_news_byid');
define('URL_GET_NEWS_BY_SLUG_V2','http://128.199.233.73/idren/api/v2/get_news_byslug?news=');
define('URL_GET_RSS_V2','http://128.199.233.73/idren/api/v2/get_rss');
define('URL_GET_TESTIMONI_V2','http://128.199.233.73/idren/api/v2/gettestimoni');
define('URL_GET_TESTIMONI_PAGGING_V2','http://128.199.233.73/idren/api/v2/gettestimoni_pagging?data=');
define('URL_GET_HERO_V2','http://128.199.233.73/idren/api/v2/gethero');
define('URL_GET_TOPOLOGI_V2','http://128.199.233.73/idren/api/v2/gettopologi');
define('URL_GET_LOGO_V2','http://128.199.233.73/idren/api/v2/getlogo');
define('URL_GET_FOOTER_V2','http://128.199.233.73/idren/api/v2/getfooter');
define('URL_GET_AKADEMISI_TITLE_V2','http://128.199.233.73/idren/api/v2/gettitleslider');
