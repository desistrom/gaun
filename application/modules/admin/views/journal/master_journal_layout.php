...
<link rel="stylesheet" href="<?=base_url();?>assets/datatables/css/dataTables.bootstrap.min.css">
	<div class="box-body">
		<div class="col col-md-12 col-sm-12 col-xs-12" style="padding-left: 0; margin-bottom: 15px;">
			<a href="<?=site_url('admin/journal/add');?>" class="btn btn-success">Tambah Kategori Journal</a>
		</div>
        ...
        <?php foreach ($kategori as $key => $value): ?>
          <tr>
						...
						<td><?=$value['nama'];?></td>
						<td>
							<a href="<?=site_url('admin/journal/edit/'.$value['id_kategori']);?>" data-toggle="tooltip" title="Edit"><button class="btn btn-info btn-sm" id="edit"><i class="fa fa-pencil"></i></button></a>
							<button class="btn btn-danger btn-sm btn_delete" id="<?=$value['id_kategori'];?>" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></button>
						</td>
          </tr>
        <?php endforeach; ?>
				</tbody>
	...
	<div class="box-header with-border">
	  ...
	  <div class="box-body">
	    <form role="form">
	      ...
	      <div class="form-group">
	        <label>Kategori</label>
	        <input type="text" name="kategori" class="form-control" id="kategori" placeholder="Enter Kategori ..." value="<?=$kategori['nama'];?>">
	        <div class="error" id="ntf_kategori"></div>
	      </div>
  ...
  $(document).ready(function () {
    ...
    $('body').on('click','.btn_delete', function(){
    	...
    	if (confirm("Ingin menhapus data ini ?")) {
	    	...
	    	$.ajax({
	          url : base_url+"admin/journal/delete/"+id,
	          dataType : 'json',
	          type : 'post',
	          data : {'id' : id},
	          async : false
