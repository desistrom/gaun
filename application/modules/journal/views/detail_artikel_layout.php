           ...
           <div class="col col-md-12 col-sm-12 col-xs-2">
            <h4 class="text-red title-sub-detail-jurnal"><?=$artikel['journal'];?></h4>
                  ...
                  <div class="filter-btn-download">
                    ...
                    <div class="inline-block"><a href="<?=site_url('journal/admin/downloads_abs/'.$artikel['id_artikel']);?>" class="btn btn-warning btn-bg btn-abstract-download">Abstract Download </a></div>
                    <?php }?>
                    <?php if($artikel['file'] != ''){?> 
                    <div class="inline-block"><a href="<?=site_url('journal/admin/downloads/'.$artikel['id_artikel']);?>" class="btn btn-warning btn-bg btn-download">Download</a></div>
                    <?php }?>
                  </div>
