...
class Journal_model extends CI_Model 
{
    ...
    ######################################################################################################################
    private function _get_datatables_query_artikel_accepted()
    {
        $user = $this->session->userdata('data_user');
        /*$sql = "SELECT * FROM tb_journal j JOIN tb_volume v ON j.id_journal = v.id_journal_ref JOIN tb_no_volume n ON v.id_volume = n.id_volume_ref JOIN tb_artikel a ON n.id_no_volume = a.id_no_volume_ref JOIN tb_author au ON a.id_artikel = au.id_artikel_ref";
        $this->db->query($sql);*/
    ...
    function get_datatables_artikel_accepted()
    {
        $this->_get_datatables_query_artikel_accepted();
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
        return $query->result();
    ...
    function count_filtered_artikel_accepted()
    {
        $this->_get_datatables_query_artikel_accepted();
        $query = $this->db->get();
        return $query->num_rows();
    ...
    public function count_all_artikel_accepted()
    {
        $this->db->from($this->table_artikel);
        return $this->db->count_all_results();
    }
    ...
    ######################################################################################################################
    private function _get_datatables_query_artikel_rejected()
    {
        $user = $this->session->userdata('data_user');
        /*$sql = "SELECT * FROM tb_journal j JOIN tb_volume v ON j.id_journal = v.id_journal_ref JOIN tb_no_volume n ON v.id_volume = n.id_volume_ref JOIN tb_artikel a ON n.id_no_volume = a.id_no_volume_ref JOIN tb_author au ON a.id_artikel = au.id_artikel_ref";
        $this->db->query($sql);*/
    ...
    function get_datatables_artikel_rejected()
    {
        $this->_get_datatables_query_artikel_rejected();
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
        return $query->result();
    ...
    function count_filtered_artikel_rejected()
    {
        $this->_get_datatables_query_artikel_rejected();
        $query = $this->db->get();
        return $query->num_rows();
    ...
    public function count_all_artikel_rejected()
    {
        $this->db->from($this->table_artikel);
        return $this->db->count_all_results();
    }
    ...
    private function _get_datatables_query_journal_download()
    {
        ...
        $this->db->where('tb_journal.id_user_ref', $user);
    ...
    ######################
    private function _get_datatables_query_download($id)
    {
        // $user = $this->session->userdata('data_user');
    ...
    function get_datatables_download($id)
    {
        $this->_get_datatables_query_download($id);
        if($_POST['length'] != -1)
        $this->db->limit($_POST['length'], $_POST['start']);
        $query = $this->db->get();
        return $query->result();
    ...
    function count_filtered_download($id)
    {
        $this->_get_datatables_query_download($id);
        $query = $this->db->get();
        return $query->num_rows();
    ...
    public function count_all_download()
    {
        $this->db->from($this->table);
        return $this->db->count_all_results();
    }
