...
.catalog{
    ...
    .catalog ul.filter-catalog{
      margin: 0;
    }
    .catalog .filter-catalog li{
      display: inline;
    ...
    .catalog .right-cat{
      text-align: center;
      /*box-shadow: 1px 1px 15px -2px rgba(0,0,0,.75);*/
    }
.catalog .filter-catalog li a{
    font-size: 12px;
    margin-bottom: 5px;
  ...
  .catalog .filter-catalog li a:hover{
...
.content-wrap  .title-keyword{
    color: #A2A2A2;
    font-size: 16px;
  margin-bottom: 15px;
  padding-bottom: 10px;
} 
.content-wrap  .title-keyword span{
  color: #D10909;
  font-weight: 600;
}
.content-wrap  .list-content-catalog{
  color: #A2A2A2;
  padding: 8px;
}
.content-wrap  .list-content-catalog a{
  color: #A2A2A2!important;
  padding: 15px;
}
.content-wrap  .list-content-catalog a:hover{
color: #D10909!important;
}
.sidebar .line-sidebar-title{
  display: inline-block;
  width: 60px;
  background-color: #D10909;
  height: 3px;
                        ...
                        <div class="filter-box-thumbnail col-md-12 col-sm-12 col-xs-12 " style="">
                          <div class="box-thumbnail">
                            ...
                            <div class="body-box-thumbnail">
                              ...
                              <div class="col col-md-12 col-sm-12 col-xs-12 none-padding">
                                <a href="<?=site_url('user/journal/download_journal/'.$value['id_journal']);?>" style="float: right;color: #EF7314;text-decoration: none;font-size: 20px;" title="download" ><i class="fa fa-download"></i></a>
                              </div>
