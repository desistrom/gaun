                              ...
                              <div class="sub-comment-right" style="box-shadow: 0 0 48px 0 #bdbdbd;">
                                  <div class="form-group">
                                      ...
                                      <div class="text-input">
                                          <input type="password" placeholder="New Password" name="new" class="input-comment">
                                          <div class="error" id="ntf_new"></div>
                                      </div>
                                      <div class="text-input">
                                          <input type="password" placeholder="Re-type New Password" name="re" class="input-comment">
