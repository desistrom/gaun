        ...
        <div class="container-fluid none-padding filter-title-page-news">
            <div class="col-md-12 col-sm-12 col-xs-12 none-padding title-page-news">
                ...
                <div class="header-title">
                    <h1 style="">Cloud Federation </h1></div>
            </div>
        </div>
            ...
            <div class="row content-news">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 content-left">
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-12 col-sm-12 col-xs-12 none-padding img-news"><img class="img-responsive" src="<?php echo $cloud['image']; ?>"></div>
                        <div class="col col-md-12 col-sm-12 col-xs-12 desrip-news">
                            <h4 class="title-news"><?php echo $cloud['judul']; ?></h4>
                            <div class="isi-news" ><?php echo $cloud['deskripsi']; ?></div>
