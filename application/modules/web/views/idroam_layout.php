            ...
            <div class="row content-news">
                ...
                <div class="col-md-8 col-sm-8 col-xs-12 content-left">
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-12 col-sm-12 col-xs-12 none-padding img-news"><img class="img-responsive" src="<?php echo $idroam['image']; ?>"></div>
                        <div class="col col-md-12 col-sm-12 col-xs-12 desrip-news">
                            <h4 class="title-news"><?php echo $idroam['judul']; ?></h4>
                            <div class="isi-news" style="padding: 0 15px;"><?php echo $idroam['deskripsi']; ?></div>
