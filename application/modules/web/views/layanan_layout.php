            ...
            <div class="col-md-12 col-sm-12 col-xs-12 none-padding title-page-news">
             ...
             <div class="col-md-12 col-sm-12 col-xs-12 content-left">
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$book['image'];?>"></div>
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$journal['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$tube['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$mail['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$research['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$link['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
                    ...
                    <div class="col col-md-12 col-sm-12 col-xs-12 none-padding list-artikel">
                        <div class="col col-md-6 col-sm-6 col-xs-6 none-padding img-news"><img class="img-responsive" src="<?=base_url();?>media/<?=$rank['image'];?>"></div>
                        <div class="col col-md-6 col-sm-6 col-xs-6 desrip-news">
