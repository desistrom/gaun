    ...
    <section class="detail_news" style="margin-top: 6em; background-color: #F2F2F2;">
        <div class="container-fluid none-padding filter-title-page-news">
            <div class="col-md-12 col-sm-12 col-xs-12 none-padding title-page-news" style="padding-bottom: 7em;">
                <div class="line-news">
                    <div></div>
                </div>
        ...
        <div class="container-fluid content-comment "  >
                    <div class="row sub-content-comment">
                      <div class="col col-md-3 col-sm-3 col-xs-12"></div>
                          <div class="col-md-6 col-sm-7 col-xs-12 right-comment" style="margin-top: -12em;">
