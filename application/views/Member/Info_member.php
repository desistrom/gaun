...
<!-- ____________________info kost______________________________--> 
	<div class="allcontain">
		<div class="feturedsection">
			<h1 class="text-center"><span class="bdots">&bullet; INFO Gaun  &bullet; </span></h1>
		</div>
					...
					<div class="row costumrow">
						...
						<div class="col-xs-12 col-sm-6 col-md-6 col-lg-6 txt1colon ">
							<div class="featurecontant">
								...
								<center><a href="<?php echo base_url()."Pesan/pemesanan/".$value->id_hunian?>" class="btn btn-primary">PESAN</a>
