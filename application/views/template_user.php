...
<!-- 
        ...
        <li class="<?php if(current_url() == site_url('user/dashboard/profil') || current_url() == site_url('user/dashboard/change_password')){ ?>  active <?php } ?> treeview" style="margin-top: 5px;">
          ...
          <ul class="treeview-menu">
            <li class="active"><a href="<?=site_url('user/dashboard/profil');?>"><i class="fa fa-circle-o"></i>Profil</a></li>

            <li class=""><a href="<?=site_url('user/dashboard/change_password');?>"><i class="fa fa-circle-o"></i> Change Password </a></li>
